...
function wordMatch(){
    ...
    if ( wordInput.value === displayedWord.innerHTML || wordInput.value.trim().toLowerCase(wordInput) === displayedWord.innerHTML ) {
